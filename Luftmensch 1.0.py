...
error3='Lo sentimos; no se pudo extraer el texto del PDF.'
...
Tip='''
Si deseas unir solo unos cuantos de los PDFs que se encuentran en la carpeta seleccionada y no todos, haz lo siguiente:
...
abouts[4]='''Une todos los PDFs que selecciones en un único archivo PDF, en el orden que escogas.
                            ...
                            try:
                                if values['SaveAs']!='':
                                    ...
                                    if values['Browse']!='':    
                                        ...
                                        Folder=os.path.abspath(os.path.join(Origin, '..'))
                                        if values['SaveAs'] not in Folder:  
